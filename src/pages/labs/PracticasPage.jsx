...
export default function PracticasPage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.practicas")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.practicas_description")}
      </motion.p>
      ...
      >
        <img
          src="/images/labs/practicas.jpg"
          alt={t("labs.practicas")}
      ...
      >
        <div>
          ...
          <p>{t("descriptions.practicas_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.practicas_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.practicas_schedule1")}</p>
          <p>{t("descriptions.practicas_schedule2")}</p>
        </div>
      </motion.div>
    </motion.section>
  );
