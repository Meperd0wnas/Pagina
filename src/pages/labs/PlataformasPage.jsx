...
export default function PlataformasPage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.plataformas")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.plataformas_description")}
      </motion.p>
      ...
      >
        <img
          src="/images/labs/plataformas.jpg"
          alt={t("labs.plataformas")}
      ...
      >
        <div>
          ...
          <p>{t("descriptions.plataformas_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.plataformas_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.plataformas_schedule1")}</p>
          <p>{t("descriptions.plataformas_schedule2")}</p>
        </div>
