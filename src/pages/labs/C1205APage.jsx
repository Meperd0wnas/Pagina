...
export default function C1205APage() {
  const { t } = useTranslation();

  useEffect(() => {
    document.title = `${t("labs.C1-205A")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.C1-205A_description")}
      </motion.p>
      ...
      >
        <div>
          ...
          <p>{t("descriptions.C1-205A_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.C1-205A_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.C1-205A_schedule1")}</p>
          <p>{t("descriptions.C1-205A_schedule2")}</p>
        </div>
      </motion.div>
    </motion.section>
  );
