...
export default function SoftwarePage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.software")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.software_description")}
      </motion.p>
      ...
      >
        <div>
          ...
          <p>{t("descriptions.software_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.software_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.software_schedule1")}</p>
          <p>{t("descriptions.software_schedule2")}</p>
        </div>
      </motion.div>
    </motion.section>
  );
