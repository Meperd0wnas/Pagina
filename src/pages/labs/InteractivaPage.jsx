...
export default function InteractivaPage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.interactiva")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.interactiva_description")}
      </motion.p>
      ...
      >
        <div>
          ...
          <p>{t("descriptions.interactiva_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.interactiva_schedule1")}</p>
          <p>{t("descriptions.interactiva_schedule2")}</p>
        </div>
      </motion.div>
    </motion.section>
  );
