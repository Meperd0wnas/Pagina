...
export default function FundamentosPage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.fundamentos")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.fundamentos_description")}
      </motion.p>
      ...
      >
        <img
          src="/images/labs/fundamentos.jpg"
          alt={t("labs.fundamentos")}
      ...
      >
        <div>
          ...
          <p>{t("descriptions.fundamentos_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.fundamentos_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.fundamentos_schedule1")}</p>
          <p>{t("descriptions.fundamentos_schedule2")}</p>
        </div>
      </motion.div>
    </motion.section>
  );
