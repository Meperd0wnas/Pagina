...
export default function RedesPage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.redes")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.redes_description")}
      </motion.p>
      ...
      >
        <div>
          ...
          <p>{t("descriptions.redes_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.redes_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.redes_schedule1")}</p>
