...
export default function EstrategiasPage() {
  ...
  useEffect(() => {
    document.title = `${t("labs.estrategias")} - Escuela Colombiana de Ingeniería Julio Garavito`;
  }, [t]);
  ...
  return (
    ...
    >
      ...
      >
        {t("descriptions.estrategias_description")}
      </motion.p>
      ...
      >
        <img
          src="/images/labs/estrategias.jpg"
          alt={t("labs.estrategias")}
      ...
      >
        <div>
          ...
          <p>{t("descriptions.estrategias_location")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.estrategias_phone")}</p>
        </div>
        ...
        <div>
          ...
          <p>{t("descriptions.estrategias_schedule1")}</p>
          <p>{t("descriptions.estrategias_schedule2")}</p>
        </div>
      </motion.div>
    </motion.section>
  );
